#-------------------------------------------------------------------------------
# Name:        Simple Neural Network frame
# Purpose:     basic functional neural network frame to predict y over x
# Author:      emanu
# Created:     15/02/2022
# Copyright:   (c) emanu 2022 -  based and adapted from Khanrad'teachings
...
#step 2 - we want to predict (y) based on n feauters (x)
...
the number of columns of a dataset to verify an idea, but it's up to you...
the last one is just one because of the target"""
